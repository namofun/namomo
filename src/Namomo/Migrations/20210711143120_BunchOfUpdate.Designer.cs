...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Blogging.Entities.BlogCommentVote", b =>
                {
            ...
            modelBuilder.Entity("Blogging.Entities.BlogPost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Blogging.Entities.BlogPostVote", b =>
                {
                    b.Property<int>("PostId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Blogging.Entities.BlogRevision", b =>
                {
            ...
            modelBuilder.Entity("SatelliteSite.IdentityModule.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -25,
                            ConcurrencyStamp = "dd824f79-3d07-299e-f87f-9267ed28e836",
                            Description = "Blog Publisher",
                            Name = "BlogPublisher",
                            NormalizedName = "BLOGPUBLISHER",
                            ShortName = "blogger"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("SatelliteSite.NamomoUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Blogging.Entities.BlogComment", b =>
                {
                    b.HasOne("Blogging.Entities.BlogPost", null)
                        .WithMany()
                        .HasForeignKey("PostId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Blogging.Entities.BlogComment", null)
                        .WithMany()
                        .HasForeignKey("ReplyToId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("SatelliteSite.NamomoUser", null)
                        .WithMany()

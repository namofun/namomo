...
namespace SatelliteSite.Migrations
{
    ...
    [Migration("20210608054949_Initialize")]
    public partial class Initialize : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PostId = table.Column<int>(nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    UserId = table.Column<int>(nullable: false),
                    CommonShared = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BlogComments_BlogComments_ReplyToId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlogPostVotes", x => new { x.PostId, x.UserId });
                    table.ForeignKey(
                        name: "FK_BlogPostVotes_BlogPosts_PostId",
                        column: x => x.PostId,
                        principalTable: "BlogPosts",
                        principalColumn: "PostId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BlogPostVotes_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlogCommentVotes", x => new { x.CommentId, x.UserId });
                    table.ForeignKey(
                        name: "FK_BlogCommentVotes_BlogComments_CommentId",
                        column: x => x.CommentId,
                        principalTable: "BlogComments",
                        principalColumn: "CommentId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BlogCommentVotes_BlogPosts_PostId",
                        column: x => x.PostId,
                        principalTable: "BlogPosts",
                        principalColumn: "PostId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BlogCommentVotes_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlogRevisions", x => x.RevisionId);
                    table.ForeignKey(
                        name: "FK_BlogRevisions_BlogComments_CommentId",
                        column: x => x.CommentId,
                        principalTable: "BlogComments",
                        principalColumn: "CommentId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BlogRevisions_BlogPosts_PostId",
                        column: x => x.PostId,
                        principalTable: "BlogPosts",
                        principalColumn: "PostId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreviousRating = table.Column<int>(nullable: true),
                    RatingDelta = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastAcRestricted = table.Column<int>(nullable: false, defaultValue: 0),
                    ...
                    LastAcPublic = table.Column<int>(nullable: false, defaultValue: 0)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_ContestBalloons_SubmissionId", x => x.SubmissionId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PolygonVersion = table.Column<int>(nullable: false),
                    RunVerdicts = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { -37, "76133040-8512-5021-491b-563056c3f919", "Plagiarism Detect User", "PlagUser", "PLAGUSER", "plaguser" },
                    ...
                    { -25, "dd824f79-3d07-299e-f87f-9267ed28e836", "Blog Publisher", "BlogPublisher", "BLOGPUBLISHER", "blogger" },
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "Color", "ContestId", "IsPublic", "Name", "SortOrder" },
                values: new object[,]
                {
                    { -5, "#ff99cc", null, true, "Organisation", 1 },
                    { -1, "#ff2bea", null, false, "System", 9 },
                    { -2, "#33cc44", null, true, "Self-Registered", 8 },
                    { -3, "#ffffff", null, true, "Participants", 0 },
                    { -4, "#ffcc33", null, true, "Observers", 0 },
                    { -6, "#96d5ff", null, true, "Companies", 1 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogComments_ReplyToId",
                table: "BlogComments",
                column: "ReplyToId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogCommentVotes_PostId_UserId",
                table: "BlogCommentVotes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogRevisions_CommentId",
                table: "BlogRevisions",
                column: "CommentId");

            migrationBuilder.CreateIndex(
                name: "IX_BlogRevisions_PostId",
                table: "BlogRevisions",
                column: "PostId");
